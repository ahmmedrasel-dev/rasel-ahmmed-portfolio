...
const About = () => {
  return (
    <div className='max-w-7xl mx-auto border-b border-slate-100 pb-10'>
      <h2 className='text-5xl text-center uppercase font-extrabold'>About Me</h2>
      <div className='grid grid-cols-2 gap-5 mt-10 justify-content-between align-items-center'>
        <div className=''>
        ...
        <div className=''>
          <h3 className='text-3xl uppercase'>Personal Information</h3>
          <ul className='personal_info'>
            <li>Name: <span className='text-white font-bold'>Rasel Ahmmed</span></li>
            <li>Email: <span className='text-white font-bold'>rahmmed.info@gmail.com</span></li>
            <li>Phone: <span className='text-white font-bold'>966572868132</span></li>
            <li>Nationality: <span className='text-white font-bold'>Bangladeshi</span></li>
            <li>Address: <span className='text-white font-bold'>Dammam, Saudi Arabia</span></li>
            <li>Language: <span className='text-white font-bold'>Bangeli, English, Arabic</span></li>
            <li>Skype: <span className='text-white font-bold'>rasel_47</span></li>
          </ul>
        </div>
